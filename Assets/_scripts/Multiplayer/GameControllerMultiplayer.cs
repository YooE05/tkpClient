...
{
    [Header("Main Links")] private bool isDemo;
    private Grid grid;
    ...
    [SerializeField] private List<ArticleTask> levelTasks = new List<ArticleTask>();
    private List<ArticleTask> DemolevelTasks = new List<ArticleTask>();

    [SerializeField] private List<LevelTrapSettings> trapSettings;
    [SerializeField] private List<SpritesSettings> spriteSettings;
    ...
    [SerializeField] private GameObject doorToNextLvl;
    [SerializeField] private GameObject trapPrefab;
    [SerializeField] private GameObject cannonPrefab;
    [SerializeField] private GameObject laserPrefab;

    [Header("RoomsGridProperties")] private int countOfRoom = 11;
    private int x = 10;
    private int y = 10;
    ...
    [SerializeField] private List<Room> roomsList = new List<Room>();
    private Dictionary<Vector2, int> roomsCoordinateDictionary = new Dictionary<Vector2, int>();

    private int currentRoomIndex;
    private Vector2 currentRoomCoordinate;

    private int maxCountRoomTasks = 2;
    private string[] articlesNamesArray = {"a", "the", "an", "none"};
    private List<Article> allArticles = new List<Article>();
    private List<Vector2> coordBetweenPhrasesParts = new List<Vector2>();
    private List<Vector2> allPhrasesCoordinates = new List<Vector2>();
    [SerializeField] private GameObject phraseForPreloadGrid;
    ...
    [SerializeField] private float countOfAllPhrases = 0;
    ...
    private void InitField()
    {
        ...
        DemolevelTasks.AddRange(levelTasks);
        isDemo = !FindObjectOfType<DataController>();
    ...
    private void GenerateLevelStruct()
    {
        playerMovement.gameObject.SetActive(false);
        RpcSetActivePortals(playerMovement.gameObject, false);
        ...
        RpcSetActivePortals(roomsList[currentRoomIndex].gameObject, true);
      //  playerMovement._grid = new GridClone(roomsList[currentRoomIndex].gridGO.GetComponent<Grid>());
        ...
        RpcSetActivePortals(playerMovement.gameObject, true);
 ...
 */
        ...
        RpcSetActivePortals(newRoom.gameObject, false);
    }
    ...
    void ChangeRoomByExit(Vector2 nextRoomDirection)
    {
        ...
        if (needChangeRoom)
        {
            ...
            RpcSetActivePortals(roomsList[currentRoomIndex].gameObject, false);
            ...
            RpcSetActivePortals(roomsList[nextRoomIndex].gameObject, true);
